...
export default function TiendasConsolidadas({ chatOpen = false, onCardClick, onVerAnalisisCompleto }: TiendasConsolidadasProps) {
  ...
  const [temporalityPeriod, setTemporalityPeriod] = useState<TemporalityPeriod>('year');

  const handleTemporalityChange = (period: TemporalityPeriod) => {
    setTemporalityPeriod(period);
    // TODO: Implement data filtering based on period
    console.log('Temporality period changed to:', period);
  };
          ...
          <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${selectedSegment === ''
              ...
              <button
                ...
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${selectedSegment === 'Hot'
              ...
              <button
                ...
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${selectedSegment === 'Balanceadas'
              ...
              <button
                ...
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${selectedSegment === 'Slow'
