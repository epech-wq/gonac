"use client";
import Checkbox from "@/components/lib/form/input/Checkbox";
...
export default function SignUpForm() {
  ...
  return (
    <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto overflow-y-auto no-scrollbar">
        <div>
