          ...
          {nav.subItems ? (
            ...
            >
              ...
              {nav.new && (isExpanded || isHovered || isMobileOpen) && (
                <span
                  className={`ml-auto absolute right-10 ${openSubmenu?.type === "main" && openSubmenu?.index === index
    ...
    >
      ...
      >
        <Link href="/">
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              <h1 className='text-2xl font-bold text-blue-600 dark:text-blue-400'>Vemio Impacta</h1>
            </>
          ) : (
            <h1 className='text-2xl font-bold text-blue-600 dark:text-blue-400'>V</h1>
          )}
        </Link>
      </div>
